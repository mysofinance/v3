...
contract MockHighFeeHandler is Ownable {
    using SafeERC20 for IERC20Metadata;

    uint256 internal constant BASE = 1 ether;
    uint96 internal constant MAX_MATCH_FEE = 0.5 ether;
    uint96 internal constant MAX_EXERCISE_FEE = 0.5 ether;
    ...
    function setMatchFeeInfo(
        ...
        if (_distPartnerFeeShare >  2 * BASE) {
