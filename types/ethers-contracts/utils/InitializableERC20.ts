...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface InitializableERC20Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'transferFrom', data: BytesLike): Result;
  ...
  export interface InitializableERC20 extends BaseContract {
    
    connect(runner?: ContractRunner | null): InitializableERC20;
    waitForDeployment(): Promise<this>;

    interface: InitializableERC20Interface;
